...
namespace WebAndroidServer.Controllers
{
        ...
        IMapper mapper, IConfiguration configuration) : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCategories()
        {
            var model = await _context.Categories
                .ProjectTo<WebSimba.Models.Category.CategoryItemModel>(mapper.ConfigurationProvider)
                .ToListAsync();
            return Ok(model);
        }
        ...
        // POST: api/Category
        [HttpPost]
        public async Task<IActionResult> PostCategory([FromForm] WebSimba.Models.Category.CategoryCreateModel model)
        {
